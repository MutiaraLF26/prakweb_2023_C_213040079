...
<html lang="en">
  <head>
    ...
    <title>Bukuku | Form Ubah Data Buku</title>
  </head>
  <body>
        ...
        <div class="col-md-6">
            <form action="" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="judul" name="judul" value="<?= $b['judul_buku']?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kategori" name="kategori" value="<?= $b['nama_kategori']?>" required>
                </div>
                <div class="mb-3">
                    <label for="gambar" class="form-label">Gambar</label>
                    <input type="text" class="form-control" id="gambar" name="gambar" value="<?= $b['gambar']?>">
                </div>
