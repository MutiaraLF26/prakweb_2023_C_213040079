...
$conn = mysqli_connect('localhost', 'root', '', 'prakweb_2023_c_213040079') or die ('Koneksi ke database GAGAL!' . mysqli_error($conn));
...
// query untuk mengambil seluruh isi dari tabel buku
    $result = mysqli_query($conn, "SELECT * FROM buku a LEFT JOIN kategori b ON a.id_kategori = b.id_kategori") or die ('Query GAGAL!' . mysqli_error($conn));
    mysqli_error($conn);
